 ...
 * {@code java -cp target/*-with-deps.jar com.onthegomap.planetiler.examples.BikeRouteOverlay osm_path="path/to/data.osm.pbf" output="data/output.mbtiles"}</li>
...
public class BikeRouteOverlay implements Profile {
  ...
  static void run(Arguments args) throws Exception {
    ...
    Planetiler.create(args)
      ...
      // override this default with output="path/to/output.mbtiles"
